...
function drawScene() 
{
    ...
    gl.uniform1f(cHeight, parseFloat(0 - cameraHeight));
...
{    
    ...
    if(shadow)
    {
        ...
        gl.uniform3f(lightingDirection, lightingD[X], lightingD[Y], lightingD[Z]);
