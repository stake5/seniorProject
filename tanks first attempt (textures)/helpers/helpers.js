...
function updateHUD()
{
	...
	document.getElementById("x").innerHTML = objects[TANK2].pos[X];
	document.getElementById("y").innerHTML = objects[TANK2].pos[Y];
	document.getElementById("z").innerHTML = objects[TANK2].pos[Z];
