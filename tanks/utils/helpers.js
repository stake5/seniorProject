...
function loadTexture(gl, textureID, path) {
    // create a javascript image object - WE MAY WANT TO MAKE THIS PART OF THE OBJECT
    var image = new Image();
    ...
    image.onload = function() {
        ...
        // flip the texture veritcally to be consistant with our vertex positions
        ...
        // instructions for how to scale the image up
        ...
        // load image into textures alloted space
        gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, image);

        // instructions for how to scale the image up and down
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
    ...
    // load the actual image from files
    image.src = path;
}
